        ...
        <main className={s.mainContainer}>
            <section className={s.quizContainer}>
                ...
                <div className={s.questionDiv}>
                    <div className={s.textContainer}>10년 전까지 연간 2000여건에 불과했던 아파트 하자 판정 건수가<br />
                    최근 5년간 연평균 4500건으로 급증했다. 단순직 외노자 급증, 무리한 공사 기간 설정 등이 원인이라는 견해가 주를 이룬다 ...</div>
                    <button/>
                </div>
                <div className={s.questionDiv}>
                    <div className={s.textContainer}>A: "야, 어제 동아리 모임에서 그 틀딱 선배 또 잔소리 엄청 하더라."<br /> 
                    B: "또? 24학번 후배들은 그 선배 딸피라고 부르던데 본인은 아는지 모르겠다."  ...</div>
                    <button/>
                </div>
                <div className={s.questionDiv}>
